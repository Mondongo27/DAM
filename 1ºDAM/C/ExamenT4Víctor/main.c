...
const char* PUNTOS="puntos.dat";
const char* DICCIONARIO="diccionario.dat";
const char* ACERTADAS="acertadas.txt";
...
char oculta[TMP];//la que hay que averiguar
char visible[TMP];//esta es la que se mostrará con _ y letras
...
int procesar(char letra, int longitud){
    int aciertos_letra=0;//aciertos de ESA letra
